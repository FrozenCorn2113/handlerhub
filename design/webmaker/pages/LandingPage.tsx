            ...
            <div className="relative z-10 grid items-center gap-16 lg:grid-cols-2">
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <button className="rounded-xl border-2 border-white/30 bg-transparent px-10 py-5 font-bold text-white transition-all hover:border-white">
                    Contact Support
                  </button>
                </div>
              </div>
              <div className="hidden grid-cols-2 gap-4 lg:grid">
                <div className="space-y-4">
                  <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur">
                    <Icons.Calendar className="mb-2 h-8 w-8 text-white" />
                    <p className="font-bold text-white">Auto-Sync Schedule</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur">
                    <Icons.Award className="mb-2 h-8 w-8 text-white" />
                    <p className="font-bold text-white">Secure Escrow</p>
                  </div>
                </div>
                <div className="mt-8 space-y-4">
                  <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur">
                    <Icons.Briefcase className="mb-2 h-8 w-8 text-white" />
                    <p className="font-bold text-white">E-Contracts</p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-white/10 p-6 backdrop-blur">
                    <Icons.Bell className="mb-2 h-8 w-8 text-white" />
