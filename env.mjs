...
export const env = createEnv({
  server: {
    ...
    RESEND_USERNAME: z.string().min(1).optional(),
    RESEND_API_KEY: z.string().min(1).optional(),
    RESEND_EMAIL_SERVER_USER: z.string().min(1).optional(),
    RESEND_EMAIL_SERVER_HOST: z.string().min(1).optional(),
    RESEND_EMAIL_SERVER_PORT: z.string().min(1).optional(),
