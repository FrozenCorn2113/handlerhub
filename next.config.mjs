...
const ContentSecurityPolicy = `
  ...
  connect-src 'self' https://*.r2.cloudflarestorage.com https://www.google-analytics.com https://vitals.vercel-insights.com https://va.vercel-scripts.com https://api.maptiler.com https://*.maptiler.com https://nominatim.openstreetmap.org https://demotiles.maplibre.org;
  img-src 'self' blob: data: https:;
  style-src 'self' 'unsafe-inline' https://fonts.googleapis.com;
  font-src 'self' https://fonts.gstatic.com https://api.maptiler.com;
  worker-src blob:;
  child-src blob:;
  object-src 'none';
  base-uri 'self';
