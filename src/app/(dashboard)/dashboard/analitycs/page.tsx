...
export default async function AnalyticsPage() {
  ...
  return (
    <DashboardShell>
      <DashboardHeader heading="Analytics" text="View your analytics." />
      <div className="flex min-h-[300px] flex-col items-center justify-center rounded-2xl border border-sand bg-white p-12 text-center shadow-md">
        ...
        <p className="mt-2 max-w-sm font-body text-sm text-warm-brown">
          Analytics and reporting are on their way. You will be able to track
          profile views, booking requests, and more.
        </p>
      </div>
    </DashboardShell>
  )
