      ...
      >
        <section>
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            ...
            <li>
              ...
              and time on site, collected through cookies
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            usage analytics. We do not use tracking cookies for advertising. You
        ...
        <section>
          ...
          <p>
            ...
            hosting practices. We use trusted third-party providers for hosting
            and authentication. While we take reasonable measures to protect
            your data, no system is completely secure.
          </p>
        </section>
