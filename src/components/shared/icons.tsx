...
export const Icons = {
  ...
  billing: CreditCard,
  dog: Dog,
  barChart: ({ ...props }: PhosphorIconProps) => (
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="fab"
  ...
  copy: Copy,
  close: X,
  discord: ({ ...props }: PhosphorIconProps) => (
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="fab"
  ...
  facebook: ({ ...props }: PhosphorIconProps) => (
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="fab"
  ...
  github: ({ ...props }: PhosphorIconProps) => (
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="fab"
  ...
  google: ({ ...props }: PhosphorIconProps) => (
    <svg
      aria-hidden="true"
      focusable="false"
      data-prefix="fab"
  ...
  help: Question,
  instagram: ({ ...props }: PhosphorIconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      aria-hidden="true"
  ...
  spinner: SpinnerGap,
  sun: Sun,
  starRating: ({ ...props }: PhosphorIconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      aria-hidden="true"
  ...
  tiktok: ({ ...props }: PhosphorIconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      aria-hidden="true"
  ...
  trash: Trash,
  twitter: ({ ...props }: PhosphorIconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      aria-hidden="true"
